...
partial class AddAppointmentWindow
{
    ...
    private void InitializeComponent()
    {
        ...
        endPicker.Location = new Point(110, 116);
        endPicker.Name = "endPicker";
        endPicker.Size = new Size(180, 23);
        endPicker.TabIndex = 7;
        ...
        remindersGroup.Size = new Size(560, 220);
        ...
        reminderTimeLabel.Name = "reminderTimeLabel";
        reminderTimeLabel.Size = new Size(37, 15);
        reminderTimeLabel.TabIndex = 0;
        reminderTimeLabel.Text = "Time";

        reminderTimePicker.CustomFormat = "yyyy-MM-dd HH:mm";
        reminderTimePicker.Format = DateTimePickerFormat.Custom;
        reminderTimePicker.Location = new Point(60, 24);
        ...
        remindersList.Name = "remindersList";
        ...
        Name = "AddAppointmentWindow";
        Text = "Add Appointment";
        remindersGroup.ResumeLayout(false);
        remindersGroup.PerformLayout();
        ResumeLayout(false);
        PerformLayout();
    }
}
